...
function parseManualDate(value) {
  ...
  /*
   * منع JavaScript من قبول
   * تاريخ غير صحيح وتحويله تلقائياً.
   *
   * مثال:
   * 31/2/2026
   */
...
export default function Crops() {
  ...
  async function handleSubmit(
    ...
    /*
     * لا يوجد أي تحقق من صيغة التاريخ.
     *
     * الشرط الوحيد:
     * يجب أن يكتب المستخدم شيئاً.
     */
    if (
