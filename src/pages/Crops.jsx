...
// DATE HELPERS
// مهم:
// التاريخ الزراعي هو DATE ONLY.
// لا نحوله إلى ISO.
// لا نستخدم new Date(dateString)
// =========================================================
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      const payload = {
        ...
        // ==============================================
        // التاريخ يحفظ حرفيًا كما أدخله المستخدم
        // ==============================================
      ...
      // لا يوجد setForm هنا.
      //
      // لذلك تبقى كل بيانات المستخدم داخل الحقول:
      // الاسم
      // البذار
      // الكمية
      // تاريخ الزراعة
