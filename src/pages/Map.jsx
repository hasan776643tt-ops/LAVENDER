    ...
    const run =
      async () => {
        ...
        */
        ...
        if (
          ...
          statusRef.current?.({
            ...
            message:
              "⚠️ تحديد الموقع يحتاج اتصال HTTPS آمن. افتح التطبيق من رابط Vercel الآمن.",
            ...
            */
            ...
            if (
              ...
              statusRef.current?.({
                ...
                message:
                  "⚠️ لم يتم السماح للموقع. اسمح للمتصفح باستخدام موقع الهاتف ثم اضغط الزر مرة أخرى.",
        ...
        */
        ...
        /*
        =====================================================
        نقل الخريطة فعليًا إلى موقع الهاتف
        =====================================================
        */
  ...
  const handleSave =
    async () => {
      ...
      */
      ...
      =======================================================
      مهم:
      هنا نبني object واحدًا واضحًا.
      useMap.addLocation(locationData)
      سيستقبله ويحفظه.
      =======================================================
      */
      ...
      const locationData = {
        ...
        /*
        -----------------------------------------------------
        الاحتفاظ بالأسماء القديمة أيضًا
        -----------------------------------------------------
        */
      ...
      */
      ...
      try {
        ...
        /*
        -----------------------------------------------------
        addLocation يعيد true عند النجاح.
        -----------------------------------------------------
        */
