...
}بالمناسبة كل شيء عمل جيدا، وضع الخريطة استجيب، اسم القرى موجود، الطرقات موجودة، كل شيء جيد جميل ممتاز، لا تغير شيء بالنسبة لأسماء القرى واسم البلدة واسم المحافظة ولا تغير أي شيء في الكود، فقط طريقة تحديد النقاط، فقط طريقة تحديد النقاط في موقع الأرض.
